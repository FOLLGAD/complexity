export function LogoSwinging() {
  return (
    <svg viewBox="0 0 113 113" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <path
        ...
        fill="#EF5C0A"
        className="origin-bottom animate-pendulum"
      />
      <path
