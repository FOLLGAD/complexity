...
export function MainContent() {
  ...
  return (
    <main className="flex max-h-screen min-h-screen flex-col items-center justify-between py-8 relative flex-shrink overflow-y-auto flex-grow overflow-hidden relative">
      <div
        className={
